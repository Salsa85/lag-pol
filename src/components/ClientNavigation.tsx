    ...
    <header className={headerClasses}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between py-4 pb-2">
          {/* Left side: Logo and Trainingen dropdown */}
          <div className="flex items-center space-x-8">
            <div className="flex items-center">
              <Image
                src="/lag-logo.png"
                alt="Lean Agile Groep"
                width={40}
                height={40}
            ...
            <div className="relative">
              ...
              <div className="absolute top-full left-0 right-0 h-2 -mt-1 z-40"></div>
              ...
              {isDropdownOpen && (
                <div
                  ...
                  className="absolute top-full left-1/2 transform -translate-x-1/2 -top-5 w-96 bg-white rounded-2xl shadow-xl border border-gray-200 z-50 py-6"
                >
                  <div className="px-6">
